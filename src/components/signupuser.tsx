...
const uSignup: React.FC = () => {
    ...
    const handleSignup = async () => {
       ...
       const signupSuccess = axios.post(baseUrl+"/register", {
        "username" : email,
        "password" : password,
        "subscriptionPlanId" : "",
        "email": email,
    ...
    return (
        <>
            ...
            <form>
                ...
                <br/>
                <IonCheckbox  checked={isChecked} onIonChange={handleCheckboxChange} /> I Agree to Users Terms and Conditions
                <br/><br/><br/>
